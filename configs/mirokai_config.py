...
WEIGHTS_DIR = "/home/anatole/Documents/SAT-TRACK/weights"
print("weights_dir", WEIGHTS_DIR)

@dataclass
class VideoConfig:
    source: str = '/home/anatole/Videos/septime/input'
    output_dir: str = '/home/anatole/Videos/septime/output'
...
@dataclass
class FullConfig:
    ip: str = "192.168.240.123"
    api_key: str = "celiocolpotomy-ring-newberyite-Podophthalma"
    seed: int = 42
