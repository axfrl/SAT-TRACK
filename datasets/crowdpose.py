...
class CROWDPOSE(BASE):
    def __init__(self, split='train', **kwargs):
        super(CROWDPOSE, self).__init__(**kwargs)
        assert split == 'train'

        self.ds_name = 'crowdpose'
        self.split = split
        self.dataset_path = os.path.join(dataset_root,'crowdpose')
        annots_path = os.path.join(self.dataset_path,'CP_NA_SMPL_train.npz')
